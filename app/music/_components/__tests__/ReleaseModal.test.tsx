...
export default function ReleaseModal({ release }: { release: Release }) {
  return (
    <Dialog>
      <DialogTrigger
        className="w-full cursor-pointer space-y-2 border border-black p-4 hover:bg-black hover:text-white">
        <Image
      ...
      <DialogContent className="flex md:max-w-2xl lg:max-w-4xl flex-col md:flex-row">
        ...
        <div className="overflow-x-auto md:mt-8.5 h-47 md:h-75 border bg-foreground">
